...
const FileUploadInput = ({ id, name, step, title, loadFile, filename }) => {
  return (
    <div className='mt-4 flex justify-center rounded-lg border-gray-900/25 px-6 py-20 bg-[#f1f0ef]'>
      <div className='text-center'>
        ...
        <div className='mt-4 flex text-sm/6 text-gray-600'>
          ...
          >
            <div className='bg-[#0176d3] hover:bg-[#032d60] text-white font-semibold text-3xl px-9 py-4 rounded-xl min-h-[140px] h-fit'>
              {title}
              {filename.length !== 0 ? <br /> : ''}
              {filename} <br />
